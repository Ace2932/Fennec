...
| 38 | **Jetson cable routing exits the −y flank, not the rear end** | Ports on the −y (robot-RIGHT) LONG face (confirmed #35) → cables exit SIDEWAYS to −y. | **DONE 2026-07-08**: cradle −y side is now a LOW rail only (h3, below the port cables) instead of a full lip → −y open for cables; riser `CASE_SLOT` moved from rear-centre (x-58..-46) to the −Y flank (**x-25..25, y-53..-47**, verified open + clear of the register tab + deck ties) → cables drop there into the bay. ⚠ still verify the −y drop reaches the boards at wiring. |
