...
| Preheat — **IR, not a hotplate** | ⬜ **none owned. CONDITIONAL BUY — run the bench test first.** Candidate: **YIHUA 853A** IR preheat station, ~$85, ceramic IR, 50–350 °C PID, **130×130 mm** heated area (listings disagree 450/600 W and 120/130 mm — check the actual one). **Must be IR, not a contact plate:** power_v2 is 112×90 mm with **both faces populated** (35 F.Cu / 26 B.Cu), so a flat plate only works while the contacting face is still bare — true up to stage 4, false for the 14 A pads at stages 6–7. MHP30 (30×30) and MHP50 (50×50) are far too small regardless. Test `U1.4` then `Q1.3` with TS-C4 at 24 V before spending |
