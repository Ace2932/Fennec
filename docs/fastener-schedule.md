...
| **knee_arm → femur shelf** ×4/leg = 16 (`knee_arm.scad`) | **M3×10 SHCS** | 2× Ø3.1 dowel-fit + 2× Ø3.4 clear through the 4.0 plate, head on top (no c'bore) | **M3×5.7 insert** in the femur shelf | **DERIVED 2026-08-02 off the meshes: plate top z=21.8, shelf face z=17.7, insert pocket bottom z=11.5 → 10.3 mm span.** M3×10 engages 5.9 mm (full insert) and stops 0.3 mm clear; **M3×12 bottoms out by 1.7 mm** | ⚠️ **THIS ROW DID NOT EXIST until 2026-08-02.** The joint is in `leg_v6/README.md` and in the CAD, but no length was recorded anywhere — the same gap that let the HFE block ship an M3×22 that bottoms out |
| **shoulder_plate → shoulder deck** ×4/plate = 16 (`shoulder_plate.scad`) | **M3×8 SHCS** | flange clear Ø3.4, head on top | **M3×5.7 insert** in the deck (`PLATE_BX`×`PLATE_BY`, bored from `DECK_Z1`=41.5) | **DERIVED 2026-08-02: flange top z=44.7, deck top z=41.5, pocket bottom z=35.3 → 9.4 mm span.** M3×8 engages 4.8 mm, 1.4 mm clear; **M3×10 bottoms by 0.6 mm** | ⚠️ Also missing until 2026-08-02. Flange thickness (3.2 mm) is bbox arithmetic — **probe it directly on the first printed shoulder** before committing to a length |
...
- **ON ORDER 2026-08-02:** M3 × 4.6 OD × 5.7 (Ruthex or equiv) **×100** · M3 × **4.0 OD × 6.0** (slim, HFE block only) **×25** · M3×16 SHCS **×20** · **M3×10 ×25** (knee_arm) · **M3×8 ×25** (shoulder_plate).
