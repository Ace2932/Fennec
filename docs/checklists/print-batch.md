...
| TPU 95A | SM3_Foot shoe ×4+1 (STOCK geometry — crush-zone v2 waits for first-article, #20), skid_rail ×2, cable_clip ×20, ~~tibia_pad~~ (RETIRED — misplaced, backlog #15; → knee-outer bumper TBD), **grommet_insert ×6** |
