...
**Every print gets a record in `docs/print-records/`** (`slice_plate.py` writes it;
commit it when the plate is actually printed) — that is the only way "which
