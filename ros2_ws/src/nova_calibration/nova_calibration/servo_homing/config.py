...
PLACEHOLDER_REASON = {
    ...
    # against a real small (well-inside-+-15) observed motion (#194,
    # record_haa_confirmation has no caller yet). A hard-stop sweep drives to
    ...
    # Unlocks once #194 lands and confirm_haa_sign() has recorded a real
    # observation for this joint (record_haa_confirmation(), limits.py:90).
