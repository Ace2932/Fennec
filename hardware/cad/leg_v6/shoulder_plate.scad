...
// HORN (rear surface = the horn plane y 17.2); top flange bolts DOWN onto
...
// Sweep-safe by construction: every solid lives at y >= 17.2 or z >= 30.
// Print: horn-seat face DOWN (perfect seat, knee_arm doctrine).

include <leg_v6_common.scad>

HIP_X   = 39.05;
FACE_Y0 = 17.2;  FACE_Y1 = 21.2;      // vertical face (4 thick)
...
module shoulder_plate_R() {
    difference() {
        ...
        // horn coupling on the REAR surface of the face
