...
$OS -o jetson_clamp.stl jetson_clamp.scad      # removable Jetson case clamp (x4)
$OS -o jetson_cowl.stl jetson_cowl.scad        # -y cable cowl (straight-plug shield)
$OS -o ../leg_v6/shoulder.stl ../leg_v6/shoulder.scad
../../../.venv/bin/python ../mesh_health.py head.stl head_ear.stl head_ear_L.stl l2_adapter.stl control_pod.stl jetson_case_mount.stl jetson_clamp.stl jetson_cowl.stl neck_bracket.stl
